...
contract TestReward is Test {
    ...
    function testInitialBalance() public {
        ...
        assertEq(reward.REWARD_AMOUNT(), 1000000, "Initial balance should be 1 million tokens");
    }
    ...
    function testDeposit1() public {
        ...
        assertEq(newBalance - initialBalance, 100, "Deposit should increase balance by 100 tokens");
    }
    ...
    function testGetBalanceWithReward1() public {
        ...
        vm.warp(1641070800);
        reward.deposit(100);
        uint256 balanceWithReward = reward.getBalanceWithReward(address(this));
